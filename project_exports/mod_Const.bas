...
Public Const RNG_MITGLIEDER_NAMEN As String = "rng_MitgliederNamen" ' HINZUFÜGEN: Für cbo_Nachpaechter
...
' --- NEU FÜR PACHTBEGINN HINZUGEFÜGT (Korrektur für M_COL_PACHTBEGINN) ---
Public Const M_COL_PACHTBEGINN As Long = 16 ' NEU: Spalte P (Datum des Pachtbeginns)
...
' --- NEU FÜR MITGLIEDSSTATUS / AUSTRETEN (Indexe angepasst) ---
Public Const M_COL_PACHTENDE As Long = 17 ' Spalte Q (Neu: Datum des Pachtendes)
Public Const M_COL_ENTITY_KEY As Long = 18 ' Spalte R (Neu: Eindeutiger Schlüssel des Mitglieds)
...
' ===============================================================
' O. PACHT- UND MITGLIEDSSTATUS (FÜR SPALTE O: M_COL_FUNKTION)
' ===============================================================
Public Const PAECHTER_STATUS As String = "PÄCHTER"
Public Const SEKUNDAER_STATUS As String = "MITGLIED (o. Pacht)"
Public Const VORSTAND_STATUS As String = "VORSTAND" ' NEU: Für Eindeutigkeitsprüfung
Public Const AUSTRITT_STATUS_HISTORIE As String = "EHEMALIG" ' Interner Status für Logik/Prüfung
Public Const AUSTRITT_STATUS_DISPLAY As String = "Ehemaliges Mitglied" ' Status für die Anzeige (Alte Konstante)
