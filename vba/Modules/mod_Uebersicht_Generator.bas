...
'        - Zeigt Soll/Ist/Status ffuer jede Kombination
...
'          Nur Zahlungstermin-Pruefung (puenktlich / Saeumnis)
'        - Saeumnis-Gebuehren werden in Bemerkung angezeigt
' FIX v1.1: InitialisiereNachDezemberCache -> InitialisiereNachDezemberCacheZP
' FIX v1.2: Val() statt CDbl() ffuer systemunabhaengiges Parsen
...
'           - Zahlungstermin-Pruefung auch ohne Soll-Betrag
'           - Saeumnis-Gebuehren in Bemerkung
...
'           - stummModus ffuer automatische Aufrufe (keine MsgBox)
'           - Trigger: Bankkonto H/I + Einstellungen -> auto-Update
' NEU v4.0: Monatsweise BeFuellung der Uebersicht
...
' NEU v4.1: Fuelligkeit-basierte Kategoriefilterung
'           - Kategorien erscheinen nur im Fuelligkeitsmonat
'             (nicht mehr in allen 12 Monaten)
'           - Fuelligkeit aus Daten Spalte O (Kategorie-Tabelle)
'           - Vorjahr-Speicher (Daten Spalten CA-CF):
'             Okt-Dez Zahlungen des Vorjahres ffuer Jan-Maerz Zuordnung
...
' Hell-gelb ffuer "bitte manuell beFuellen" (Soll-Betrag variabel)
...
' Status-String ffuer gruen (Encoding-sicher, wird in Init gesetzt)
...
' ===============================================================
' Type ffuer eine dynamische Kategorie aus Einstellungen
' ===============================================================
...
' v3.0: stummModus ffuer automatische Aufrufe (ohne MsgBox)
' ===============================================================
Public Sub GeneriereUebersicht(Optional ByVal jahr As Long = 0, _
    ...
    ' Alten Inhalt Loeschen (ab Zeile 4, inkl. Spalte I)
    ...
    ' Dezember-Cache initialisieren (ffuer Vorauszahlungen)
    ...
    For Each mitglied In mitglieder
        ...
        For monat = 1 To 12
            ...
            For k = 0 To anzahlKat - 1
                ...
                ' =============================================
                ' v2.0: Bemerkung mit Saeumnis-Info
                ' =============================================
                ...
                ' Saeumnis-Gebuehr anhaengen wenn Status ROT und Gebuehr definiert
                If StrComp(status, "ROT", vbTextCompare) = 0 Then
...
NextMitglied:
    ...
    ' Blatt schuetzen (Soll-Zellen ohne festen Betrag bleiben editierbar)
...
' ===============================================================
' v4.0: prueft ob eine Kategorie in einem bestimmten Monat Fuellig ist
...
NextPos:
    ...
    ' v7.4: Dashboard auf aktuellen Stand bringen, falls Status-Aenderungen
