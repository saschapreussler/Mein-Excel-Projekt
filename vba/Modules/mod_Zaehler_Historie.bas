...
' enthaelt: SchreibeHistorie, FarbeHistorieEintraege
' ===============================================================

' --- Konstanten (lokal dupliziert) ---
Private Const HIST_SHEET_NAME As String = "Zaehlerhistorie"
...
Public Sub SchreibeHistorie( _
    ...
    ' 5. Farben ffuer Historie setzen & Update-Call
    Select Case Medium
        Case "Strom"
            lngColor = RGB_STROM
        Case "Wasser"
