...
'       DropDown zur Verfuegung (inkl. Sammelzahlung)
' ===============================================================
...
Public Sub KategorieEngine_Pipeline(Optional ByVal wsBK As Worksheet)
    ...
    ' Kategorie-Listen auf Daten! aktualisieren (ffuer DropDowns)
    ...
    For r = BK_START_ROW To lastRowBK
        ...
        ' DropDown ffuer ROT und GELB setzen
...
'       zur Verfuegung - auch Sammelzahlung.
' ===============================================================
...
' ===============================================================
' DropDown-Validierung ffuer Spalte H (Kategorie) setzen
...
Private Sub SetzeKategorieDropDown(ByVal wsBK As Worksheet, ByVal rowBK As Long)
    ...
    ' Zelle muss entsperrt sein ffuer Validation
...
' ===============================================================
' Re-Evaluierung nach EntityRole-Aenderung (ffuer eine IBAN)
' ===============================================================
...
NextRowReEval:
    ...
    If anzahlNeu > 0 Then
        Debug.Print "Re-Evaluierung: " & anzahlNeu & " Zeilen ffuer IBAN " & Left(ibanClean, 8) & "... neu bewertet."
    End If
