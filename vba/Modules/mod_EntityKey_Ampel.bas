...
' ZWECK: Ampelfarben-System (Gr?n/Gelb/Rot) f?r EntityKey-Tabelle
' ABGELEITET AUS: mod_EntityKey_Manager (Modularisierung)
' VERSION: 1.0 - 01.03.2026
' FUNKTIONEN:
'   - SetzeAmpelFarbe: Farbe f?r Spalten U-X einer Zeile setzen
'   - SetzeAlleAmpelfarbenNachSortierung: Alle Zeilen nach Sort
'   - BerechneAmpelStatus: Status-Logik (1=Gr?n, 2=Gelb, 3=Rot)
' ***************************************************************

' ===============================================================
' Setzt Farbe f?r Spalten U-X einer Zeile
' ampelStatus: 1=Gr?n, 2=Gelb, 3=Rot
' ===============================================================
...
' ===============================================================
' Setzt Ampelfarben f?r ALLE Zeilen NACH Sortierung
' EHEMALIGES MITGLIED in Historie -> GR?N
' ===============================================================
Public Sub SetzeAlleAmpelfarbenNachSortierung(ByRef wsD As Worksheet)
    ...
    For r = EK_START_ROW To lastRow
        ...
        ' Bei EHEMALIGES MITGLIED pr?fen ob in Historie
...
Public Function BerechneAmpelStatus(ByVal entityKey As String, _
    ...
    ' GR?N: Alles vorhanden und sicher
    If entityKey <> "" And role <> "" Then
        If zuordnung <> "" Then
