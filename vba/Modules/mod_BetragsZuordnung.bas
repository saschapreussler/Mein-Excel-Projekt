...
' FIX: GELB (Sammelzahlung) wird uebersprungen - keine
'      Betragszuordnung und kein ueberschreiben auf ROT!
...
Public Sub ApplyBetragsZuordnung(ByVal wsBK As Worksheet, _
    ...
    ' Der Nutzer muss die Betraege manuell aufteilen.
    ...
    ' Zielspalte abhaengig vom Vorzeichen suchen
