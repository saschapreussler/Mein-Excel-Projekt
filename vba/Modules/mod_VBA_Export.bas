...
Public Sub ExportiereAlleVBAKomponenten()
    ...
    ' Pr�fe ob Zugriff auf VBA-Projekt erlaubt ist
    ...
    ' Pr�fe ob Zielordner existieren
    ...
    For Each vbComp In vbProj.VBComponents
        ...
        Select Case vbComp.Type
            ...
            Case 100 ' vbext_ct_Document - Dokument/Arbeitsblatt (.cls)
                ' Arbeitsbl�tter und ThisWorkbook als Klassen exportieren
                exportPath = EXPORT_PATH_CLASSES
                extension = ".cls"
    ...
    If countSkipped > 0 Then
        msg = msg & vbCrLf & "�bersprungen: " & countSkipped
    End If
...
' ===============================================================
' HILFSFUNKTION: Pr�ft ob Ordner existiert
' ===============================================================
