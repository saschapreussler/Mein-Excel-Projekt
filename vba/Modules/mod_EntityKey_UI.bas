...
' ZWECK: UI-Interaktion und manuelle Zuordnung f?r EntityKey-System
' ABGELEITET AUS: mod_EntityKey_Manager (Modularisierung)
' VERSION: 1.0 - 01.03.2026
' FUNKTIONEN:
'   - VerarbeiteManuelleRoleAenderung: Event-Handler f?r Spalte W
'   - SetupEntityRoleDropdown: DropDown f?r EntityRole-Spalte
'   - SetupParzelleDropdown: DropDown f?r Parzelle-Spalte
...
' ===============================================================
' Verarbeitet manuelle Role-?nderung in Spalte W
' ===============================================================
Public Sub VerarbeiteManuelleRoleAenderung(ByVal Target As Range)
    ...
    ' Sortierung + Ampelfarben sofort nach manueller ?nderung
...
' ===============================================================
' Setzt EntityRole-Dropdown f?r eine Zeile
' ===============================================================
...
' ===============================================================
' Setzt Parzellen-Dropdown f?r eine Zeile
' ===============================================================
