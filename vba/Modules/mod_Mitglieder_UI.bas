...
Public Sub Fuelle_MemberIDs_Wenn_Fehlend()
    ...
    For lRow = M_START_ROW To lastRow
        ' Pr?fen, ob eine MemberID fehlt und ob der Datensatz nicht leer ist
...
' ***************************************************************
' HILFSFUNKTION: GUID erstellen (PUBLIC - f?r frm_Mitgliedsdaten zugaenglich)
' ***************************************************************
...
Public Sub ApplyMitgliederDropdowns()
    ...
    ' --- Dynamische Quelle f?r Spalte O (Funktion) ---
    ...
    For lRow = M_START_ROW To ws.Cells(ws.Rows.count, M_COL_PARZELLE).End(xlUp).Row
        If Trim(ws.Cells(lRow, M_COL_PARZELLE).value) = PARZELLE_VEREIN Then
            ...
            If vereinRowNachname <> "" Then
                ...
                Debug.Print "WARNUNG: Verein-Parzelle-Zeile (" & vereinParzelleRow & ") enth?lt Mitgliederdaten: " & vereinRowNachname
            End If
            Exit For
        End If
    Next lRow
...
' ***************************************************************
' HILFSFUNKTION: Pr?fen, ob eine UserForm geladen ist
' ***************************************************************
