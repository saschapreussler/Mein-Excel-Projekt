...
' ZWECK: Visuelles Dashboard auf Blatt "?bersicht (neu)"
...
' ============================================================
'  TYPES (m?ssen VOR allen Sub/Function stehen!)
' ============================================================
...
' ============================================================
'  FARBEN (Public f?r mod_Dashboard_Matrix)
' ============================================================
...
' Layout-Konstanten (Public f?r Matrix-Modul)
...
Public Sub GeneriereUebersichtNeu(Optional ByVal stummModus As Boolean = False)
    ...
    ' --- 4. Soll-Werte aus ?bersicht laden ---
...
Private Function HoleOderErstelleSheet() As Worksheet
    ...
    If ws Is Nothing Then
        ' Direkt hinter dem Blatt "Zahlungs?bersicht" einf?gen
    ...
    For Each m In mitglieder
        ...
        Else
            ...
            If InStr(tempArr(ix).entityKeys, m("EntityKey")) = 0 Then
                ' Neuer EntityKey f?r diese Parzelle -> hinzufuegen
            ...
            ' v5.2: Name IMMER pr?fen (auch wenn EntityKey bereits bekannt),
...
'  Liest manuell eingetragene Soll-Betr?ge (Parzelle|Kategorie)
' ============================================================
...
'  zu vermeiden - nutzt Nachname als Schl?sselwort.
' ============================================================
    ...
    For Each mlM In mitgliederML
        ...
        For p = 1 To anzParz
            If parzellen(p).parzNr = pNr Then
                ...
                ' Pr?fen ob Name schon enthalten ist
                ...
                ' Nachname extrahieren (letztes Wort) f?r robusteren Vergleich
