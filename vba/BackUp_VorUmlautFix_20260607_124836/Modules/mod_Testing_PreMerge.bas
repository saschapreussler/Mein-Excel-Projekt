...
Private Sub Test_9_MitgliederhistorieIntakt()
    ...
    If lastRow >= H_START_ROW Then
        ...
        Debug.Print "? Blatt existiert und ist befällt"
    Else
...
Public Sub DebugZebraFormatierung()
    ...
    ' 3. Zellfürbungen prüfen (direkte Farben)
    ...
    Debug.Print "   Für Zeile 7: MOD(7-6;2)=1 -> MOD(1;2)=1 -> TRUE ? (sollte gefürbt sein)"
