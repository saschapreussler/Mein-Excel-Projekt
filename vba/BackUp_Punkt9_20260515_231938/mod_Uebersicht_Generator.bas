...
' NEU v4.0: Monatsweise Bef?llung der Übersicht
...
'             Okt-Dez Zahlungen des Vorjahres für Jan-M?rz Zuordnung
...
Private Sub SetzeUebersichtHeader(ByVal wsUeb As Worksheet)
    ...
    ' Zeile 1 als Titelzeile mit definierter Höhe (62 Punkte)
