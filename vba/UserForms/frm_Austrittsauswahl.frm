...
Private Sub UserForm_Initialize()
    ...
    Me.Caption = "Austrittsgrund w�hlen"
...
Private Sub cmd_OK_Click()
    If Me.opt_Nachpaechter.value Then
        ' Pr�fe ob Nachp�chter ausgew�hlt wurde
        If Trim(Me.cbo_Nachpaechter.value) = "" Then
            ' Frage ob Nachp�chter bereits im System ist
            Dim antwort As VbMsgBoxResult
            antwort = MsgBox("Ist der Nachp�chter bereits im System registriert?", vbYesNoCancel + vbQuestion, "Nachp�chter registriert?")
            
            If antwort = vbYes Then
                ' Ja - Nachp�chter muss ausgew�hlt werden
            ...
            ElseIf antwort = vbNo Then
                ' Nein - Neuer Nachp�chter muss angelegt werden
                MsgBox "Es muss ein neuer Nachp�chter erfasst werden.", vbInformation, "Nachp�chter erfassen"
                
                m_SelectedOption = 1
                m_CustomReason = "uebergabe an Nachp�chter"
...
Private Sub FuelleNachpaechterComboBox()
    ...
    ' Dictionary f�r eindeutige Namen (verhindert Duplikate
    ...
    For lRow = M_START_ROW To lastRow
        ...
        If Trim(ws.Cells(lRow, M_COL_NACHNAME).value) <> "" And _
           ...
           StrComp(Trim(ws.Cells(lRow, M_COL_PARZELLE).value), "Verein", vbTextCompare) <> 0 Then
            ...
            ' Nur Hinzuf�gen wenn Name noch nicht in der Liste ist
