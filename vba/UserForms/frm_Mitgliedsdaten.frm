...
Private Sub cmd_Uebernehmen_Click()
    ...
    ' MsgBox "Fehler beim Speichern der Aenderungen" ausloeste.
    ...
    If lRow < 2 Then
        MsgBox "Interner Fehler: Datenzeile nicht ermittelbar (Tag=" & CStr(Me.tag) & ")." & vbCrLf & _
               "Bitte das Formular schliessen und das Mitglied erneut aus der Liste oeffnen.", _
               vbCritical, "Speichern nicht moeglich"
        Exit Sub
    End If
