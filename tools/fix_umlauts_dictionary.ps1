...
$pairs = @(
    ...
    # ---- ERWEITERUNG 3: 2. Run nach Reimport (08.06.2026) ---------------
    # Lange Wörter zuerst (Greedy-Schutz: substr nicht vorher matchen)
    @('Sammel?berweisungen',  'Sammel{ue}berweisungen'),
    @('PARZELLENZ?HLER',      'PARZELLENZ{AE}HLER'),
    @('Z?HLERWECHSEL',        'Z{AE}HLERWECHSEL'),
    @('UNTERZ?HLER',          'UNTERZ{AE}HLER'),
    @('Z?HLERLOGIK',          'Z{AE}HLERLOGIK'),
    @('Hauptz?hler',          'Hauptz{ae}hler'),
    @('Z?hlerstands',         'Z{ae}hlerstands'),
    @('Z?hlerstand',          'Z{ae}hlerstand'),
    @('Z?hlerhistorie',       'Z{ae}hlerhistorie'),
    @('Z?hlers',              'Z{ae}hlers'),
    @('Z?hler',               'Z{ae}hler'),
    ...
    @('Geb?hren',             'Geb{ue}hren'),
    @('Geb?hr',               'Geb{ue}hr'),
    @('S?umnishinweis',       'S{ae}umnishinweis'),
    @('S?umnis',              'S{ae}umnis'),
    @('Nachp?chter',          'Nachp{ae}chter'),
    @('P?chter',              'P{ae}chter'),
    @('F?lligkeitsdatum',     'F{ae}lligkeitsdatum'),
    @('F?lligkeitsmonat',     'F{ae}lligkeitsmonat'),
    @('F?lligkeitstypen',     'F{ae}lligkeitstypen'),
    @('F?lligkeit',           'F{ae}lligkeit'),
    @('f?llig',               'f{ae}llig'),
    @('Halbj?hrlich',         'Halbj{ae}hrlich'),
    @('j?hrlich',             'j{ae}hrlich'),
    @('Toleranzpr?fung',      'Toleranzpr{ue}fung'),
    @('Vorabpr?fung',         'Vorabpr{ue}fung'),
    @('Zeitfensterpr?fung',   'Zeitfensterpr{ue}fung'),
    @('PR?FUNG',              'PR{UE}FUNG'),
    @('Pr?fungen',            'Pr{ue}fungen'),
    @('Pr?fix',               'Pr{ae}fix'),
    @('Pr?fe',                'Pr{ue}fe'),
    @('Pr?ft',                'Pr{ue}ft'),
    @('pr?fen',               'pr{ue}fen'),
    @('Ung?ltiger',           'Ung{ue}ltiger'),
    @('Ung?ltige',            'Ung{ue}ltige'),
    @('ung?ltig',             'ung{ue}ltig'),
    @('Endg?ltigen',          'Endg{ue}ltigen'),
    @('vollst?ndigen',        'vollst{ae}ndigen'),
    @('vollst?ndige',         'vollst{ae}ndige'),
    @('vollst?ndig',          'vollst{ae}ndig'),
    @('UNGESCH?TZT',          'UNGESCH{UE}TZT'),
    @('gesch?tzt',            'gesch{ue}tzt'),
    @('sch?tzen',             'sch{ue}tzen'),
    @('sch?tzt',              'sch{ue}tzt'),
    @('Sch?tze',              'Sch{ue}tze'),
    @('Wert?nderung',         'Wert{ae}nderung'),
    @('ge?ndert',             'ge{ae}ndert'),
    @('aufgef?llt',           'aufgef{ue}llt'),
    @('vorbef?llt',           'vorbef{ue}llt'),
    @('bef?llt',              'bef{ue}llt'),
    @('bef?llen',             'bef{ue}llen'),
    @('gef?llten',            'gef{ue}llten'),
    @('gef?llt',              'gef{ue}llt'),
    @('gef?rbt',              'gef{ae}rbt'),
    @('f?rben',               'f{ae}rben'),
    @('F?RBT',                'F{AE}RBT'),
    ...
    @('Halbj?',               'Halbj{ae}'),
    @('Betr?ge',              'Betr{ae}ge'),
    @('Betr?gen',             'Betr{ae}gen'),
    @('w?hlen',               'w{ae}hlen'),
    @('anw?hlen',             'anw{ae}hlen'),
    @('ausgew?hlten',         'ausgew{ae}hlten'),
    @('W?hle',                'W{ae}hle'),
    @('M?chten',              'M{oe}chten'),
    @('k?nnten',              'k{oe}nnten'),
    @('k?nnen',               'k{oe}nnen'),
    ...
    @('Enth?lt',              'Enth{ae}lt'),
    @('Eintr?ge',             'Eintr{ae}ge'),
    @('Abh?ngigkeiten',       'Abh{ae}ngigkeiten'),
    @('abh?ngig',             'abh{ae}ngig'),
    ...
    @('hei?t',                'hei{ss}t'),
    @('Flie?komma',           'Flie{ss}komma'),
    @('abschlie?endes',       'abschlie{ss}endes'),
    @('auszuschlie?ende',     'auszuschlie{ss}ende'),
    @('Best?tige',            'Best{ae}tige'),
    @('Z?hlerst',             'Z{ae}hlerst'),
    @('vervollst?ndigen',     'vervollst{ae}ndigen'),
    @('Unvollst?ndige',       'Unvollst{ae}ndige'),
    @('Geb?hren',             'Geb{ue}hren'),
    @('STABILIT?T',           'STABILIT{AE}T'),
    ...
    @('Ziel?berschrift',      'Ziel{ue}berschrift'),
    @('Bin?rdaten',           'Bin{ae}rdaten'),
    @('Gesch?ftslogik',       'Gesch{ae}ftslogik'),
    @('ZELLF?RBUNGEN',        'ZELLF{AE}RBUNGEN'),
    @('Unterst?tzte',         'Unterst{ue}tzte'),
